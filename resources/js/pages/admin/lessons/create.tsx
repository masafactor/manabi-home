...
export default function AdminLessonsCreate({ subjects }: Props) {
    const { data, setData, post, processing, errors } = useForm<LessonForm>({
        subject_id: '',
        grade: '',
        unit_name: '',
        title: '',
    ...
    return (
        <div className="p-6">
            <div className="mb-6">
                <h1 className="text-2xl font-bold">授業動画登録</h1>
