...
} from '@/types/teacher-student';

type Props = {
    student: TeacherStudent;
    summary: TeacherStudentSummary;
    lessonViews: TeacherLessonView[];
    quizAttempts: TeacherQuizAttempt[];
    learningLogs: TeacherLearningLog[];
};
...
const submitComment = (learningLogId: number) => {
    post(route('teacher.learning-logs.comments.store', learningLogId), {
        preserveScroll: true,
...
const deleteComment = (commentId: number) => {
    router.delete(route('teacher.learning-log-comments.destroy', commentId), {
        preserveScroll: true,
    });
};
    return (
                          ...
                          {learningLogs.map((log) => (
                            <div key={log.id} className="rounded-md border p-4">
                                ...
                                <div className="mt-4 border-t pt-4">
                                    <h4 className="text-sm font-semibold">先生コメント</h4>
